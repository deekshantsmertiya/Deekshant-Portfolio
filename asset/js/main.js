        ...
        $('#form-contact').each(function () {
            $(this).validate({
                submitHandler: function (form) {
                    ...
                    var whatsappText = "Hello Deekshant! I would like to get in touch.\n\n" +
                        "*Email:* " + email + "\n" +
                        "*Phone:* " + phone + "\n" +
                        "*Message:* " + msg;

                    var whatsappUrl = "https://wa.me/919119181071?text=" + encodeURIComponent(whatsappText);
                    window.open(whatsappUrl, '_blank');

                    var alertBox = $('<div class="custom-centered-alert msg-success">' +
                        '<div class="alert-content">' +
                        '<h4 class="alert-title">Redirecting!</h4>' +
                        '<p class="text-body-1">Opening WhatsApp to send your message...</p>' +
